...
const CompanysecretarialservicesTitle = [
  ...
  { title: "Private Placement", desc: "Execute private placements.", icon: <FaUserShield /> }, // 🛡 Secure investor placement
  { title: "Buyback", desc: "Carry out a share buyback.", icon: <FaExchangeAlt /> }, // 🔄 Exchange/return
  { title: "Reduction of Share Capital", desc: "Reduce share capital.", icon: <FaCompressArrowsAlt /> }, // 🔽 Reduction
  { title: "Shift of Registered Office", desc: "Move your registered office.", icon: <FaMapMarkerAlt /> }, // 📍 Location change
  { title: "Name Change", desc: "Convert your business entity.", icon: <FaEdit /> }, // ✏ Name editing
  { title: "Conversion of Entities", desc: "Register your start-up.", icon: <FaBuilding /> }, // 🏢 Company structure change
  { title: "Capital Issue", desc: "Issue new capital.", icon: <FaMoneyBillWave /> }, // 💵 Money issuance
  { title: "Charge Compliances", desc: "Ensure compliance with charges.", icon: <FaBalanceScale /> }, // ⚖ Legal compliance
  { title: "Alteration of MOA & AOA", desc: "Amend the Memorandum and Articles of Association.", icon: <FaFileSignature /> }, // 📝 Signing documents
  { title: "ESOP", desc: "Implement Employee Stock Ownership Plans.", icon: <FaUsersCog /> }, // 👥 Employee stock options
  { title: "CSR", desc: "Comply with Corporate Social Responsibility requirements.", icon: <FaHandsHelping /> }, // 🤝 CSR/helping hands
];
    ...
    <>
      <section className="relative z-10 overflow-hidden pt-20">
        ...
        <div
          ...
          style={{ backgroundImage: `url(${startImage5})` }}
        >
          {/* ✅ Overlay */}
          ...
          <div className="relative z-10 text-center max-w-5xl w-full px-4 text-gray-900">
            ...
            <p className="mt-5 sm:mt-8 font-serif sm:text-lg md:text-xl text-gray-700 font-medium max-w-3xl mx-auto animate-fadeInBottom">
              ...
              updates, we ensure your business adheres to all legal
