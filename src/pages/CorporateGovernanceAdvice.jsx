...
import startImage14 from "@/assets/Corporate_Governance_image.jpg";
...
const CorporategovernanceadviceandsupportTitle = [
  {
    title: "Reporting",
    desc: "Provide corporate governance reporting.",
...
const Corporategovernanceadviceandsupport = () => {
  return (
    <div>
      <section className="relative z-10 overflow-hidden pt-20">
        ...
        <div
          ...
          style={{ backgroundImage: `url(${startImage14})` }}
        >
          {/* Overlay */}
            ...
            <div className="pt-4 pb-2 px-4 sm:px-8 md:px-16 lg:px-20 ">
              <div className="w-full mx-auto">
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                  {CorporategovernanceadviceandsupportTitle.map(
                    (item, index) => (
...
export default Corporategovernanceadviceandsupport;
