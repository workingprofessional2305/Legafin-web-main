...
import startImage16 from "@/assets/Administration_image.jpg";
...
import { MdOutlinePolicy, MdOutlineManageAccounts } from "react-icons/md";
...
const GeneralAdministrationTitle = [
  ...
  {
    title: "HR Matters",
    desc: "Handle HR-related matters.",
    icon: <FaUsersCog />,
  },
  {
    ...
    <div>
      <section className="relative z-10 overflow-hidden pt-20">
        ...
        <div
          ...
          style={{ backgroundImage: `url(${startImage16})` }}
        >
          {/* Overlay */}
