...
import startImage20 from "@/assets/Laisoning_image.jpg";
import {
  RiContactsLine,
  RiGovernmentLine,
  RiBuilding2Line,
...
import { FaUniversity, FaBalanceScale, FaIndustry } from "react-icons/fa";
...
const LiaisoningTitle = [
  ...
  {
    title: "CLB",
    desc: "Liaison with the Company Law Board.",
    icon: <FaBalanceScale />,
  },
  {
    title: "NCLT",
    ...
    <div>
      <section className="relative z-10 overflow-hidden pt-20">
        ...
        <div
          ...
          style={{ backgroundImage: `url(${startImage20})` }}
        >
          {/* Overlay */}
