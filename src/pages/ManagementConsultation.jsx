...
import { RiContactsLine, RiLightbulbFlashLine } from "react-icons/ri";
...
const ManagementConsultationTitle = [
  {
    ...
    desc: "Develop business strategies.",
  ...
  },
  {
    ...
    desc: "Create effective business models.",
    icon: <MdOutlineBusinessCenter />,
  },
  {
    title: "Product Development",
    desc: "Assist with product development.",
    ...
    <div>
      <section className="relative z-10 overflow-hidden pt-20">
        ...
        <div
          ...
          style={{ backgroundImage: `url(${startImage15})` }}
        >
          {/* Overlay */}
